			...
			<form action="controller.do" method="post">
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" name="ouro" placeholder="ouro">
					</div>
					<div class="form-group col-md-6">
						<label><strong>Prata</strong></label>
						<input type="text" class="form-control" name="prata" placeholder="prata">
					</div>
					<div class="form-group col-md-6">
						<label><strong>Bronze</strong></label>
						<input type="text" class="form-control" name="bronze" placeholder="bronze">
					</div>
				</div>
				<hr />
